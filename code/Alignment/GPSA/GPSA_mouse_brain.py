...
pd.DataFrame(view_idx["expression"]).to_csv("/home/zhaoshangrui/xuxinyu/GPSA/mouse_brain_noimage/result/view_idx_visium.csv")
pd.DataFrame(X).to_csv("/home/zhaoshangrui/xuxinyu/GPSA/mouse_brain_noimage/result/X_visium.csv")
pd.DataFrame(Y).to_csv("/home/zhaoshangrui/xuxinyu/GPSA/mouse_brain_noimage/result/Y_visium.csv")
data.write("/home/zhaoshangrui/xuxinyu/GPSA/mouse_brain_noimage/result/data_visium.h5")
...
for t in range(N_EPOCHS):
    ...
    if t % PRINT_EVERY == 0:
        ...
        plt.draw()
        plt.savefig("/home/zhaoshangrui/xuxinyu/GPSA/mouse_brain_noimage/result/visium_aligned_difference_one_gene.png")
        plt.pause(1 / 60.0)

        pd.DataFrame(curr_aligned_coords).to_csv("/home/zhaoshangrui/xuxinyu/GPSA/mouse_brain_noimage/result/aligned_coords_visium.csv")
...
plt.tight_layout()
plt.savefig("/home/zhaoshangrui/xuxinyu/GPSA/mouse_brain_noimage/result/visium_alignment.png")
# plt.show()
plt.close()

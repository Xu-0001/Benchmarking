...
mydata <- h5read("/home/zhaoshangrui/xuxinyu/PASTE_1/human_heart/result/data_mat.h5","mat")
mat <- mydata$block0_values
rownames(mat) <- as.character(mydata$axis0)
colnames(mat) <- as.character(mydata$axis1)
mat <- Matrix(mat, sparse = TRUE)
meta <- read.table("/home/zhaoshangrui/xuxinyu/PASTE_1/human_heart/result/data_metadata.tsv",sep="\t",header=T,row.names=1)
pos <- read.table("/home/zhaoshangrui/xuxinyu/PASTE_1/human_heart/result/data_position_spatial.tsv",sep="\t",header=T,row.names=1)
...
saveRDS(obj, file='/home/zhaoshangrui/xuxinyu/PASTE_1/human_heart/result/original_slice.RDS')
...
file_path <- '/home/zhaoshangrui/xuxinyu/PASTE_1/human_heart/result/original_slice.RDS'
...
seulist_split <- list()
slice_ids <- c('FH6_1000L2_CN73_C2', 'FH6_1000L2_CN73_D2', 'FH6_1000L2_CN73_E1', 'FH6_1000L2_CN73_E2', 'FH6_1000L2_CN74_C1', 'FH6_1000L2_CN74_D1', 'FH6_1000L2_CN74_D2', 'FH6_1000L2_CN74_E1', 'FH6_1000L2_CN74_E2')
for (i in 1:length(slice_ids)) {
  slice_id <- slice_ids[i]
  slice_seurat <- subset(seulist, subset = Sample == slice_id)
...
seuList <- list()
for (r in 1:M) {
  seuList[[r]] <- CreateSeuratObject(counts = countList[[r]], meta.data = metadataList[[r]], project = "human_heart")
}
saveRDS(seuList, file='/home/zhaoshangrui/xuxinyu/PRECAST/human_heart/result/human_heart_seuList.RDS')
...
saveRDS(seuInt, file='/home/zhaoshangrui/xuxinyu/PRECAST/human_heart/result/human_heart_seuInt.RDS')

cell_embeddings <- seuInt@reductions$PRECAST@cell.embeddings
write.csv(cell_embeddings, file = "/home/zhaoshangrui/xuxinyu/PRECAST/human_heart/result/PRECAST_embed.csv", row.names = TRUE)

...
result_dirs="/home/zhaoshangrui/xuxinyu/SPIRAL/adult_mouse_brain/result/"
...
common_items = adata.obs_names.intersection(New_Coord.index)
aligned_spatial_data = New_Coord.loc[common_items, ['x', 'y']].to_numpy()
adata.obsm['aligned_spatial'] = adata.obsm['spatial']
aligned_indices = adata.obs_names.isin(common_items)
adata.obsm['aligned_spatial'][aligned_indices, :] = aligned_spatial_data
adata.obs['cluster'] = adata.obs['louvain'] 
adata.write("/home/zhaoshangrui/xuxinyu/SPIRAL/adult_mouse_brain/result/ann_cluster.h5ad")

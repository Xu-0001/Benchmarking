...
adata = sc.read_h5ad("/home/zhaoshangrui/xuxinyu/PRECAST/mouseOB_20/slideV2_MOB16_rep2_merge70_seulist.h5ad")
adata.obsm['spatial'] = adata.obsm['X_position']
adata.obs["batch"] = adata.obs["batch"].astype('category')
# >>> adata
# AnnData object with n_obs × n_vars = 74624 × 2000
#     obs: 'nCount_RNA', 'nFeature_RNA', 'row', 'col', 'batch'
#     var: 'name'
#     obsm: 'X_position', 'spatial'
...
result_dirs="/home/zhaoshangrui/xuxinyu/SPIRAL/mouseOB_20/result/"
IDX=np.arange(0,16)
VF=[]
MAT=[]
...
for i in np.arange(len(IDX)):
    mat=MAT[i]
    mat=mat.loc[:,VF]
    mat.to_csv(result_dirs + "get_input_scanpy/" +str(IDX[i])+ "_features-1.txt")  
...
sc.tl.louvain(ann,resolution=0.5)
...
ann.write("/home/zhaoshangrui/xuxinyu/SPIRAL/mouseOB_20/result/ann.h5ad")
...
ann.write("/home/zhaoshangrui/xuxinyu/SPIRAL/mouseOB_20/result/ann_cluster.h5ad")
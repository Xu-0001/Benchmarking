...
result_dirs="/home/zhaoshangrui/xuxinyu/SPIRAL/Drosophila_embryoE16-18/result/"
...
cluster_file=result_dirs+"gtt_output/SPIRAL_mclust.csv"
pd.DataFrame(ann.obs['mclust']).to_csv(cluster_file)

ann.write("/home/zhaoshangrui/xuxinyu/SPIRAL/Drosophila_embryoE16-18/result/ann.h5ad")

...
adata = sc.read_h5ad("/home/zhaoshangrui/xuxinyu/datasets/mouseLiver8/seulist_mouseLiverST8.h5ad")
...
result_dirs="/home/zhaoshangrui/xuxinyu/SPIRAL/mouseLiver8/result/"
...
result_dirs="/home/zhaoshangrui/xuxinyu/SPIRAL/mouseliver/result/"
samples=np.arange(0,8)
...
embed_file=result_dirs+"gtt_output/SPIRAL"+"_embed_"+str(SPII.params.batch_size)+".csv"
...
ann.write("/home/zhaoshangrui/xuxinyu/SPIRAL/mouseliver/result/ann.h5ad")

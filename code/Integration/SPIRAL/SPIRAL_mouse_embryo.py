...
result_dirs="/home/zhaoshangrui/xuxinyu/SPIRAL/mouse_embryo/result/"
...
adata.write("/home/zhaoshangrui/xuxinyu/SPIRAL/mouse_embryo/result/ann.h5ad")

sc.pp.neighbors(adata, use_rep='spiral', random_state=666)
sc.tl.louvain(adata, random_state=666, key_added="louvain", resolution=0.4)

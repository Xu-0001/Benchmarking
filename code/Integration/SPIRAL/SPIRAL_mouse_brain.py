...
data_slice1.obs['batch'] = 'sention_1'
...
data_slice2.obs['batch'] = 'sention_2'

Batch_list = [data_slice1, data_slice2]
   
result_dirs="/home/zhaoshangrui/xuxinyu/SPIRAL/mouse_brain/result/"
...
sc.tl.louvain(ann, random_state=666, key_added="louvain", resolution=0.5)
...
ann.write("/home/zhaoshangrui/xuxinyu/SPIRAL/mouse_brain/result/ann.h5ad")
...
ann.obsm['aligned_spatial'] = ann.obsm['spatial'].copy()
matching_cells = New_Coord.index[New_Coord.index.isin(ann.obs_names)]
ann.obsm['aligned_spatial'][ann.obs_names.get_indexer(matching_cells)] = New_Coord.loc[matching_cells, ['x', 'y']].values
ann.write("/home/zhaoshangrui/xuxinyu/SPIRAL/mouse_brain/result/ann_aligned.h5ad")

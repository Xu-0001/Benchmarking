...
adata_concat.write("/home/zhaoshangrui/xuxinyu/STAligner/mouseLiver8/mouseLiver8.h5ad")

staligner_df = pd.DataFrame(adata_concat.obsm['STAligner'])
staligner_df.index = adata_concat.obs_names
staligner_df.to_csv('/home/zhaoshangrui/xuxinyu/STAligner/mouseLiver8/mouseLiver8_STAligner_embed.csv', index=True)

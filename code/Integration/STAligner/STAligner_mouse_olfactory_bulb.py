...
for i in range(1,17):
    ...
    STAligner.Cal_Spatial_Net(data, rad_cutoff=100) # the spatial network are saved in adata.uns[‘adj’]
...
adata_concat.write("/home/zhaoshangrui/xuxinyu/STAligner/mouseOB_20/mouseOB.h5ad")

staligner_df = pd.DataFrame(adata_concat.obsm['STAligner'])
staligner_df.index = adata_concat.obs_names
staligner_df.to_csv('/home/zhaoshangrui/xuxinyu/STAligner/mouseOB_20/mouseLiver8_STAligner_embed.csv', index=True)
